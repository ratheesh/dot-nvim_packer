...
hl(0, "WilderWildmenuAccent", { fg = "#ee0000" })
hl(0, "WilderWildmenuSelectedAccent", { fg = "#ee0000" })
hl(0, "VirtColumn", { fg = colors.lightbg2, bg = colors.black })
hl(0, "TreesitterContext", { bg = "#343848" })

-- Treesitter highlighting
hl(0, "TSProperty"        ,   {fg="#e1e1e1", bg=nil, italic = false, bold = false})
hl(0, "TSString"          ,   {fg="#7d8590", bg=nil, italic = false, bold = false})
hl(0, "TSStringEscape"    ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSNumber"          ,   {fg="#1DAA89", bg=nil, italic = false, bold = false})
hl(0, "TSKeyword"         ,   {fg="#6272a4", bg=nil, italic = false, bold = false})
hl(0, "TSFunction"        ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSType"            ,   {fg="#698BB8", bg=nil, italic = false, bold = false})
hl(0, "TSTypeBuiltin"     ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSFuncBuiltin"     ,   {fg="#bab0ab", bg=nil, italic = false, bold = false})
hl(0, "TSMethod"          ,   {fg="#8da0cb", bg=nil, italic = false, bold = false})
hl(0, "TSConstant"        ,   {fg="#709081", bg=nil, italic = false, bold = false})
hl(0, "TSConstructor"     ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSSymbol"          ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSBoolean"         ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSFloat"           ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSField"           ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSParameter"       ,   {fg="#B6819E", bg=nil, italic = false, bold = false})
hl(0, "TSPunctDelimiter"  ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSConstBuiltin"    ,   {fg="#a0a0a0", bg=nil, italic = false, bold = false})
hl(0, "TSKeywordFunction" ,   {fg="#B38376", bg=nil, italic = false, bold = false})
hl(0, "TSVariableFunction",   {fg="#B38376", bg=nil, italic = false, bold = false})
hl(0, "TSVariable"        ,   {fg="#c0c0c0", bg=nil, italic = false, bold = false})
hl(0, "TSInclude"         ,   {fg="#BC70A4", bg=nil, italic = false, bold = false})
hl(0, "TSKeywordOperator" ,   {fg="#67CCDC", bg=nil, italic = true , bold = true })
