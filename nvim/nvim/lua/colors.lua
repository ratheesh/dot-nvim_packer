...
hl(0 , "MatchParen"   , { fg = nil      , bg = "#2a354e", italic = false, bold = true , underline = true  })
...
hl(0 , "rainbowcol2" , { fg = "#FA2CA7", bg = nil, italic = false, bold = true, underline = false })
...
hl(0 , "rainbowcol6" , { fg = "#fbb4ae", bg = nil, italic = false, bold = true, underline = false })
