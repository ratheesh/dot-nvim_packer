...
hl(0 , "CmpItemKindVariable"   		, { fg = "#C76D83" , bg = nil , italic = true  , bold = true  , underline = false })
hl(0 , "CmpItemKindInterface"  		, { fg = "#00A7CF" , bg = nil , italic = true  , bold = true  , underline = false })
hl(0 , "CmpItemKindText"       		, { fg = "#C586C0" , bg = nil , italic = true  , bold = true  , underline = false })
hl(0 , "CmpItemKindFunction"   		, { fg = "#00A7CF" , bg = nil , italic = true  , bold = true  , underline = false })
hl(0 , "CmpItemKindMethod"     		, { fg = "#C586C0" , bg = nil , italic = true  , bold = true  , underline = false })
hl(0 , "CmpItemKindKeyword"    		, { fg = "#fbb4ae" , bg = nil , italic = true  , bold = true  , underline = false })
hl(0 , "CmpItemKindSnippet"    		, { fg = "#9467bd" , bg = nil , italic = true  , bold = true  , underline = false })
hl(0 , "CmpItemKindConstructor"   , { fg = "#A3BE8C" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindField"         , { fg = "#9467bd" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindClass"         , { fg = "#9c755f" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindModule"        , { fg = "#3DB4AE" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindProperty"      , { fg = "#F06372" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindUnit"          , { fg = "#9c755f" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindValue"         , { fg = "#EBCB8B" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindEnum"          , { fg = "#9467bd" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindColor"         , { fg = "#97B7D7" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindFile"          , { fg = "#E0AF8F" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindReference"     , { fg = "#97B7D7" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindFolder"        , { fg = "#E0AF8F" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindEnumMember"    , { fg = "#3D7BBF" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindConstant"      , { fg = "#6B717C" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindStruct"        , { fg = "#af7aa1" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindEvent"         , { fg = "#3D7BBF" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindOperator"      , { fg = "#ef8d97" , bg = nil , italic = false , bold = true  , underline = false })
hl(0 , "CmpItemKindTypeParameter" , { fg = "#97B7D7" , bg = nil , italic = false , bold = true  , underline = false })
