...
hl(0 , "PmenuSel"     , { fg = "#c0c0c0" , bg = "#45525F" , italic = false , bold = false , underline = false })
...
hl(0 , "WildSelectedAccent" , { fg = "#2AD198" , bg = "#3d506c" , italic = true  , bold = true  , underline = true  })
